...
- (void)loadFont:(JS::NativeDynamicFonts::DynamicFontSource &)options callback:(RCTResponseSenderBlock)callback
{
    ...
    if (![mimeType isEqual:[NSNull null]]) {
      ...
      if ( [mimeType isEqualToString:@"application/x-font-ttf"] ||
        ...
        type = @"ttf";
                  ...
                  [mimeType isEqualToString:@"font/otf"] ) {
        type = @"otf";
      }
    }
  }
...
- (void)loadFontFromFile:(JS::NativeDynamicFonts::DynamicFontFileSource &)options callback:(RCTResponseSenderBlock)callback
{
  NSString *name = options.name();
...
- (std::shared_ptr<facebook::react::TurboModule>)getTurboModule:(const facebook::react::ObjCTurboModule::InitParams &)params {
  return std::make_shared<facebook::react::NativeDynamicFontsSpecJSI>(params);
}
